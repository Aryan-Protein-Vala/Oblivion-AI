...
export async function loadValidConfigOrThrow(): Promise<OblivionConfig> {
...
export async function updateConfig(
  mutator: (cfg: OblivionConfig) => OblivionConfig,
...
export function resolveModelTarget(params: { raw: string; cfg: OblivionConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: OblivionConfig): Set<string> {
