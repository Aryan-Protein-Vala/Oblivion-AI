...
export function applyVercelAiGatewayProviderConfig(cfg: OblivionConfig): OblivionConfig {
...
export function applyVercelAiGatewayConfig(cfg: OblivionConfig): OblivionConfig {
