...
export function applyOpencodeZenProviderConfig(cfg: OblivionConfig): OblivionConfig {
...
export function applyOpencodeZenConfig(cfg: OblivionConfig): OblivionConfig {
