...
function resolveDefaultAccountId(cfg: OblivionConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: OblivionConfig): boolean {
...
export function summarizeBindings(cfg: OblivionConfig, bindings: AgentBinding[]): string[] {
