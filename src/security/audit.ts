...
function collectLoggingFindings(cfg: OblivionConfig): SecurityAuditFinding[] {
...
function collectElevatedFindings(cfg: OblivionConfig): SecurityAuditFinding[] {
  const findings: SecurityAuditFinding[] = [];
...
function collectExecRuntimeFindings(cfg: OblivionConfig): SecurityAuditFinding[] {
  const findings: SecurityAuditFinding[] = [];
