...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof OblivionConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: OblivionConfig; env: NodeJS.ProcessEnv }): {
  cfg: OblivionConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
