...
import type { OblivionConfig } from "./types.js";
...
function resolveAnthropicDefaultAuthMode(cfg: OblivionConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: OblivionConfig): OblivionConfig {
...
export function applyTalkApiKey(config: OblivionConfig): OblivionConfig {
...
export function applyTalkConfigNormalization(config: OblivionConfig): OblivionConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: OblivionConfig): OblivionConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: OblivionConfig): OblivionConfig {
...
export function applyLoggingDefaults(cfg: OblivionConfig): OblivionConfig {
...
export function applyContextPruningDefaults(cfg: OblivionConfig): OblivionConfig {
...
export function applyCompactionDefaults(cfg: OblivionConfig): OblivionConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
