...
function resolveResolutionLimits(config: OblivionConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: OblivionConfig): SecretProviderConfig {
