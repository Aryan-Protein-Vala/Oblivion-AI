...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: OblivionConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: OblivionConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: OblivionConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: OblivionConfig }): Promise<void> {
