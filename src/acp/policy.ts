...
export function isAcpEnabledByPolicy(cfg: OblivionConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: OblivionConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: OblivionConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: OblivionConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: OblivionConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: OblivionConfig, agentId: string): boolean {
