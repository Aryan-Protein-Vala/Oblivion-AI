...
function buildHooksReport(config: OblivionConfig): HookStatusReport {
...
function enableInternalHookEntries(config: OblivionConfig, hookNames: string[]): OblivionConfig {
