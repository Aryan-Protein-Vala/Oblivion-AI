...
import { type OblivionConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: OblivionConfig): string[] {
...
export function listAgentsForGateway(cfg: OblivionConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: OblivionConfig): string {
...
function resolveSessionStoreAgentId(cfg: OblivionConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: OblivionConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: OblivionConfig): GatewaySessionsDefaults {
