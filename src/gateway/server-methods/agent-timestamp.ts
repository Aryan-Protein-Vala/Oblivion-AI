...
import type { OblivionConfig } from "../../config/types.js";
...
/**
 * Build TimestampInjectionOptions from an OblivionConfig.
 */
export function timestampOptsFromConfig(cfg: OblivionConfig): TimestampInjectionOptions {
  return {
