...
export function resolveHooksConfig(cfg: OblivionConfig): HooksConfigResolved | null {
...
function resolveKnownAgentIds(cfg: OblivionConfig, defaultAgentId: string): Set<string> {
