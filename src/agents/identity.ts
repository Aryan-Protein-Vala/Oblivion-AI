import type { OblivionConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveIdentityName(cfg: OblivionConfig, agentId: string): string | undefined {
