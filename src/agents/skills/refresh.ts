...
function resolveWatchPaths(workspaceDir: string, config?: OblivionConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: OblivionConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: OblivionConfig }) {
