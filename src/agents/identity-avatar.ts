...
function resolveAvatarSource(cfg: OblivionConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: OblivionConfig, agentId: string): AgentAvatarResolution {
