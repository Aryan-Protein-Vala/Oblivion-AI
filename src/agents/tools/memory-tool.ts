...
function resolveMemoryToolContext(options: { config?: OblivionConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: OblivionConfig): MemoryCitationsMode {
