...
export type { OblivionConfig } from "../config/config.js";
/** @deprecated Use OblivionConfig instead */
export type { OblivionConfig as ClawdbotConfig } from "../config/config.js";
